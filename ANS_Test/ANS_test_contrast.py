...
def get_file_dict():
    ...
    pattern = re.compile(r'dots_image_(\d{1,2})x(\d{1,2})_contrast.png')
...
def run_ANS_test():
    ...
    data_dict = {
        ...
        'subject': major,
        'score': total_score,
        'image names contrast': shuffled_image, 
        'image answers contrast': shuffled_answers,
        'input answers': input_answers,
        'reaction times': response_times
    }
    
    form_url = 'https://docs.google.com/forms/d/e/1FAIpQLSdfAFL6-yDLEKid8A4WcewnCMQoBiyOI8uBwrrnk1p6RjxVLQ/viewform?usp=sf_link'
